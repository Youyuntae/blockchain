...
document.getElementById("STATE").innerHTML=result;
	...
	auction.Myedu( function(error, result){
document.getElementById("edu_brand").innerHTML=result[0];
